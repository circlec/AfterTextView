...
public class MainActivity extends AppCompatActivity {
    ...
    private String testText = "测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！测试用文字多几个！";
